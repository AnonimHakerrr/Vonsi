...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        const response = await http_api.get<BookingDetails[]>(
          "api/Booking/getAll",
          {
            headers: {
  ...
  const handleSaveSettings = async () => {
    try {
      ...
      navigate("/");
      console.log("Дані користувача оновлено:", res.data);
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            {booking
                              ? `${new Date(
                                  ...
                                  months[new Date(booking.checkIn).getMonth()]
                                }`
                              : ""}
                          </div>
                          <div className="flex items-center gap-1">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span>
                            {bookingDetailsModal.room.details.roomNumber}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Поверх:</span>
                          <span>{bookingDetailsModal.room.details.floor}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Площа:</span>
                          <span>{bookingDetailsModal.room.details.size}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Ліжко:</span>
                          <span>
                            {bookingDetailsModal.room.details.bedType}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-1 text-sm">
                        {bookingDetailsModal.room.amenities?.map(
                          (amenity, index) => (
                            <div
                              key={index}
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span>
                            {
                              new Date(bookingDetailsModal.checkIn)
                                .toISOString()
                                .split("T")[0]
                            }
                          </span>
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>
                            {
                              new Date(bookingDetailsModal.checkOut)
                                .toISOString()
                                .split("T")[0]
                            }
                          </span>
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>
                            {(new Date(bookingDetailsModal.checkOut).getTime() -
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  // дозволяємо лише букви, апостроф та дефіс
